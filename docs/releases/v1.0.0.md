...
## Support and Community / 赞赏与交流

The app home page and README include:

- WeChat reward QR code for voluntary support
- WeChat contact QR code for feedback and community discussion
